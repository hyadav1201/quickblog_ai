...
const Header = () => {
  ...
  return (
    <div className='mx-8 sm:mx-16 xl:ml-24 relative'>
...
text-primary'>
            ...
            <form onSubmit={onSubmitHandler} className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
                <input ref={inputRef} id="search" type="text" placeholder='Search for blogs' required  className='w-full pl-4 outline-none'/>
