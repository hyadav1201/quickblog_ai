...
function Newsletter() {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      <h1 className='md:tet-4xl text-2xl font-semibold'>Never Miss a Blog!</h1>
      ...
      <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
        <input type="text" placeholder="Enter your email id" id="Subscribe" required className='border border=fray-300  rounded=md h-full border-r-0 outline-none w-full rounded-r-none px-3 text-gray-500'/>
